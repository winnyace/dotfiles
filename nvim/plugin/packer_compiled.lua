...
_G.packer_plugins = {
  ...
  indentLine = {
    loaded = true,
    path = "/home/ion/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/home/ion/.local/share/nvim/site/pack/packer/start/neovim-ayu",
  ...
  ["vim-airline"] = {
    loaded = true,
    path = "/home/ion/.local/share/nvim/site/pack/packer/start/vim-airline",
